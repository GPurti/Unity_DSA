...
public class InfoUser : MonoBehaviour
{
    ...
    private void DrawMiniMap()
    {
        ...
        {
        ____________________EXEMPLE___________*/
            GameObject gadget1 = (GameObject)Instantiate(gadget, new Vector3((float)-0.4, (float)-0.3, 1), gadget.transform.rotation);
            gadget1.transform.SetParent(transform);/*
        ______________EXEMPLE_______________
        ...
        */
        ...
        transform.localScale = new Vector3(400, 200, 0);
        /*
